...
exports.uploadFileController = async function (req, res) {
    try {
        ...
        var wrapperObject = {};
        var awsCredentials = {
            ridesDataBucket: process.env.AWS_RIDES_DATA_BUCKET+ '/temp-package' + timestamp,
        ...
        return responseHandler.success(req,res, 'Uploaded Successfully', wrapperObject.url);
