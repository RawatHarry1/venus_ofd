...
exports.updateBannerType = async function (req, res) {
    try {
      ...
      return responseHandler.success(req,res, 'Banner type updated successfully', '');
    } catch (error) {
      errorHandler.errorHandler(error, req, res);
    }
};
...
exports.deleteBannerType = async function (req, res) {
    try {
        ...
        params = [opts.id];
        await db.RunQuery( dbConstants.DBS.LIVE_DB,query,params);
      return responseHandler.success(req,res, 'Banner type deleted successfully', '');
    } catch (error) {
      errorHandler.errorHandler(error, req, res);
    }
};
...
exports.createBanner = async function (req, res) {
    try {
        ...
        let params = [opts.banner_type_id, opts.banner_image, opts.is_active || 0, opts.banner_order || null, opts.banner_redirected_url || null,req.operator_id, opts.city_id];
        await db.RunQuery(
            dbConstants.DBS.LIVE_DB,
            query,
            params,
